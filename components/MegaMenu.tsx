        ...
        return (
          ...
          >
            ...
            >
              ...
              <span className={`absolute bottom-0 left-0 w-full h-[3px] bg-ibc-brand transform transition-all duration-300 ease-out origin-center ${
                                         ...
                                         <ul className="space-y-3">
                                           {section.children?.map((sub) => (
                                             <li key={sub.label} className="flex items-start">
                                                <Link to={sub.href} className="group block text-[14px] font-normal text-gray-400 hover:text-white transition-colors leading-relaxed hover:translate-x-1 duration-200">
                                                  {sub.label}
                                                </Link>
                                             </li>
                                           ))}
                                  ...
                                  {child.children ? (
                                    ...
                                    <ul className={`grid gap-x-8 gap-y-3 ${child.itemGridCols ? `grid-cols-${child.itemGridCols}` : 'grid-cols-1'}`}>
                                      {child.children.map((sub) => (
                                        <li key={sub.label}>
                                          <Link to={sub.href} className="group flex items-start text-[14px] text-gray-400 hover:text-white transition-colors duration-200">
                                    ...
                                    <Link to={child.href} className="text-sm font-bold text-ibc-brand hover:text-green-400 flex items-center mt-2 group">
